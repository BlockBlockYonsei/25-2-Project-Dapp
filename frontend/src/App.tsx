...
function App() {
  ...
  const handleCreateSupport = (name: string, email: string, description: string, imageUrl: string, amount: number, walletAddress: string) => {
    // 받은 데이터로 새로운 카드 객체를 만듭니다.
    const newCard: SponsorCardProps = { name, email, description, imageUrl, walletAddress };
      ...
      >
        <Flex align="center" gap="6"> 
          <Box>
            ...
            <Text size="2" color="gray">창작자에게 Sui를 후원해보세요!</Text>
          </Box> 
        </Flex>
